...
//*****************************************************/
public class BlockN {//main big class where the magic happens

	public static void main(String[] args) {
		SimpleDateFormat dateFormat=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS");//to format our timeStamps for PQ
