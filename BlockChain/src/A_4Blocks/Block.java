...
public class Block{
    ...
    private String[] transactions;//tracks block chain transactions
    private String prevHashID;//gets previous hash id
    ...
    private int nonce_randomSeed;//helps with generating distinct block
    private int proof_of_work;
    private int blockNumber = 1;
    private String hashID;
    private UUID uuid;//more unique identification of block
    private String BlockID;//standard identification of block
    ...
    public String getDOB(){//get method for date of birth
        return dob;
    }
    public String getRx(){//get method for Rx
        return Rx;
    }
    public String getSSNum(){//get method for social
        return ssNumber;
    }
    public String getTreatment(){//get method for treatment
        return treatment;
    }
    public String getIllness(){//get method for illness
        return illness;
    }
    public int getNonce_RS(){//get method for nonce
        return this.nonce_randomSeed;
    }
    public int setNonce_RS(int nc_rs){//set method to make sure we have a value
        return this.nonce_randomSeed = nc_rs;
    }
    public String getPrevHashID(){//get method for previous hash
        return prevHashID;
    }
    ...
    public String calcHashID(){//create the hash using all the block properties. We use the SHA256 algo to help
