...
public static void main(String[] args) {
    ...
    dummyBlock.ReadJSON("blockDummy.json");
	...
	private String[] transactions;
	  ...
	  public void ReadJSON(String JsonFileName) {
		  ...
		  try (Reader reader = new FileReader(JsonFileName)){
			  ...
			  BlockMaker blockMakerIn = gson.fromJson(reader, BlockMaker.class);
			  
			  //print BlockMaker
			  System.out.println("GSON block object: "+blockMakerIn);
			  System.out.println("Name is: "+blockMakerIn.firstName+" "+blockMakerIn.lastName);
			  
			  String INuuid = blockMakerIn.uuid.toString();
			  System.out.println("String UUID: "+blockMakerIn.BlockID+" Stored-binaryUUID: "+INuuid);
			  
			  String INdob = blockMakerIn.dob;
			  String INrx = blockMakerIn.Rx;
			  String INssNum = blockMakerIn.ssNumber;
			  String INtreatment = blockMakerIn.treatment;
			  String INillness = blockMakerIn.illness;
			  String INtimestamp = blockMakerIn.timeStamp;
			  
			  System.out.println("Time Stamp: "+INtimestamp);
			  System.out.println("Date of Birth: "+INdob);
			  System.out.println("Social Security Number: "+INssNum);
			  System.out.println("Illness "+INillness);
			  System.out.println("Rx: "+INrx);
			  System.out.println("Treatment: "+INtreatment);
