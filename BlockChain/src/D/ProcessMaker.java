...
class StartEverything {//A sort of Client class
...
//A sort of Server class
public class ProcessMaker extends Thread {//can run on different shells, will accept multicast messages from common machine socket
